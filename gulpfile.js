 ...
 * @license ISC
 *
 * AngularJS Music Search: Build, watch and other useful tasks
 *
...
gulp.task('minify-css', function() {
  gulp.src(['./assets/scss/**/*.css', '!./styles/**/*.min.css'])
...
gulp.task('minify-html', function() {
  ...
  gulp.src('./*.html')
    ...
    .pipe(gulp.dest('./_build/html'));
});

// copy fonts from a module outside of our project (like Bower)
gulp.task('fonts', function() {
  gulp.src('./asssets/fonts/**/*.{ttf,woff,eof,eot,svg}')
...
gulp.task('default', ['browser-sync', 'sass', 'minify-css'], function() {
  gulp.watch('assets/scss/*.css', function(file) {
    if (file.type === "changed") {
      reload(file.path);
    }
  });
  gulp.watch(['*.html'], ['bs-reload']);
  gulp.watch(['app/*.js', 'assets/**/**.js'], ['bs-reload']);
